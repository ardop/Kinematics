...
double PCA9685::getPWMol(int channel)
{
double temp;
temp= readByte(PCA9685_LED0_ON_L+4*channel);
return temp;
}
double PCA9685::getPWMoh(int channel)
{
double  temp;
temp= readByte(PCA9685_LED0_ON_H+4*channel);
return temp;
}
double  PCA9685::getPWMofl(int channel)
{
double  temp;
temp= readByte(PCA9685_LED0_OFF_L+4*channel);
return temp;
}
double  PCA9685::getPWMofh(int channel)
{
double  temp;
temp= readByte(PCA9685_LED0_OFF_H+4*channel);
return temp;
}
